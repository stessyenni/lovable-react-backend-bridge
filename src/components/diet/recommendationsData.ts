...
export const cameroonRecommendations: DietRecommendation[] = [
  ...
  {
    id: '2', name: 'African Plum (Safou)',
    description: 'Local fruit rich in healthy fats and fiber',
    category: 'weight-loss', type: 'fruit', image: safou,
  ...
  {
    id: '3', name: 'Okra Soup (Gombo)',
    description: 'Light okra soup with minimal palm oil and lean protein',
    category: 'weight-loss', type: 'delicacy', image: okraSoup,
  ...
  {
    id: '4', name: 'Koki with Palm Oil',
    description: 'High-calorie cowpea pudding with palm oil and spices',
    category: 'weight-gain', type: 'delicacy', image: koki,
  ...
  {
    id: '5', name: 'Plantain with Groundnut Sauce',
    description: 'Fried plantain with rich groundnut (peanut) sauce',
    category: 'weight-gain', type: 'delicacy', image: plantainGroundnut,
  ...
  {
    id: '9', name: 'Fufu with Light Vegetable Soup',
    description: 'Moderate portions of cassava fufu with vegetable soup',
    category: 'maintain', type: 'delicacy', image: fufuSoup,
  ...
  {
    id: '10', name: 'Garden Egg with Groundnut Paste',
    description: 'Local eggplant variety with protein-rich groundnut paste',
    category: 'maintain', type: 'vegetable', image: gardenEgg,
