          ...
          <TabsContent value="chatbot" className="mt-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Chat with our AI assistant for health advice and recipe suggestions
                </CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground">AI Chatbot will be implemented once Supabase is connected.</p>
              </CardContent>
            </Card>
          </TabsContent>
        </Tabs>
